...
namespace StegProject
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dPic.Filter = "Файлы изображений (*.png)|*.png|Все файлы (*.*)|*.*";
            ...
            dSavePic.Filter = "Файлы изображений (*.png)|*.png|Все файлы (*.*)|*.*";
            ...
            bPic.Save(wFile, System.Drawing.Imaging.ImageFormat.Png);
